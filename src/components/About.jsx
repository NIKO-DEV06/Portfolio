  ...
  return (
    <section className="text-white bg-black-gradient h-screen ">
      <div className="relative md:ml-[13rem]">
        ...
        <h1 className="text-[1.5rem] font-[600] leading-[2.5rem] text-center tracking-[0.1em] relative lg:text-[3rem] lg:tracking-[0.07rem] lg:font-[500] opacity-50">
          About Me
        </h1>
      </div>
      <div className="lg:flex lg:mx-auto lg:mt-[8rem]">
        <p className="font-[300] p-[1.35rem] md:ml-[16rem] md:mt-3 md:leading-[1.5rem] lg:mt-8 lg:ml-[19rem] lg:w-[43%] lg:scale-110 lg:leading-[1.7rem]">
          ...
          <span className="opacity-50">
            JavaScript, React Js, NextJs, Typescript, Redux, Tailwind and other
        ...
        <div className="relative w-[18rem] mx-auto lg:mx-auto md:mx-[23rem] lg:scale-90 lg:my-auto">
          <img
            src={myLogo}
            alt=""
            className="rounded-sm h-[18rem] mt-3 relative z-[2]"
          />
          <div className="w-[18rem] h-[18rem] border-2 absolute inset-0 left-[1rem] top-[1rem] lg:left-[1.1rem] lg:top-[1.8rem]"></div>
        </div>
      </div>
    </section>
  );
