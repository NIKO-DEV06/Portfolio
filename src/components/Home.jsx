...
const Home = () => {
  return (
    <section className="text-white h-screen bg-black-gradient">
      <h1 className="pt-[270px] text-[1.5rem] font-[600] leading-[2.5rem] text-center tracking-wider">
        Welcome, I'm Emmanuel.
        <br />
        <div className="text-[1.3rem] font-[500]">
      ...
      <div className="flex justify-center translate-y-[-1.5rem] gap-[1.5rem]">
        <motion.div
