...
const SideBar = () => {
  return (
    <Fragment>
      <div className="hidden sm:flex fixed top-0 bottom-0 left-0 w-[260px] overflow-y-auto text-center bg-[#1c1c1c] border-r-[1.5px] border-[#282828] md:flex flex-col text-white">
        ...
        <div className="text-[14px] flex flex-col gap-3 mt-3">
          ...
          <div className="flex mx-6 text-left opacity-50 hover:opacity-100 duration-300 cursor-pointer">
            <img src={projectsSvg} alt="" className="h-[1.7rem] my-auto ml-2" />
          ...
          <div className="flex mx-6 text-left opacity-50 hover:opacity-100 duration-300 cursor-pointer">
            <img src={contactSvg} alt="" className="h-[1.7rem] my-auto ml-2" />
        ...
        <div className="text-[14px] flex flex-col gap-3 mt-3">
          <div className="flex mx-6 text-left opacity-50 hover:opacity-100 duration-300 cursor-pointer">
            <img src={linkedinSvg} alt="" className="h-[1.7rem] my-auto ml-2" />
